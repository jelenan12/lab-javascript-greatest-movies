...
//1st iteration  
var directorNames = movies.map(movie)=>
return movie.director
);
console.log([directorNames]);

//2nd iteration
const howManyMovies=movies.filter(function(movie){ if (movie.director == 'Steven Spielberg' && movie.genre.includes ('Drama'))
...
const sortedByTitle=movies.slice().sort((a,b)=>{
if (a.title>b.title) return 1;
if(a.title<b.title) return -1;
return 0;
}); 
const titlesOnly = sortedByTitle.map(movie => movie.title);
